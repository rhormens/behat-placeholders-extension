...
final class PlaceholdersExtension implements Extension {
    ...
    private function loadPlaceholdersController(ContainerBuilder $container) {
        $definition = new Definition('Ciandt\Behat\PlaceholdersExtension\Cli\PlaceholdersController');
    ...
    protected function loadStepTester(ContainerBuilder $container, $variantTags,$environment)
    {
        ...
        $container->setDefinition(TesterExtension::STEP_TESTER_WRAPPER_TAG . '.placeholder_replacer', $definition);
    }
